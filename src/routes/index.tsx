...
import { Bell, ChevronRight, UserRound, Compass, Lock } from "lucide-react";
...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Отраслевой банк — здоровье бизнеса в одном балле" },
      {
        name: "description",
        content:
          "Оценка состояния бизнеса, ключевые инсайты и персональные рекомендации по росту выручки и удержанию клиентов.",
      },
      { property: "og:title", content: "Отраслевой банк — здоровье бизнеса" },
      {
          ...
          <Card>
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                <h2 className="text-base font-semibold leading-snug">Советник</h2>
                <p className="mt-1 text-xs text-muted-foreground">
                  Инсайты и рекомендации, что делать дальше
                </p>
              </div>
