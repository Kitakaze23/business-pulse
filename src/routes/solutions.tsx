...
export const Route = createFileRoute("/solutions")({
  ...
  head: () => ({
    meta: [
      { title: "Сервисы для вас — Отраслевой банк" },
      {
        name: "description",
        content:
          "Сервисы и решения для задач вашего бизнеса: счёт, приём оплаты, продвижение, бухгалтерия и управление — подобраны по данным Отраслевой банк.",
      },
      { property: "og:title", content: "Сервисы для вас — Отраслевой банк" },
      {
        ...
        <Card>
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            {isLaunch
              ...
              : "Сервисы подобраны по данным Отраслевой банк и текущим задачам бизнеса."}
          </p>
        </Card>
