...
const demoDialog: Msg[] = [
  {
    id: 1,
    role: "agent",
    text: "Добрый день, Григорий Александрович! Я ваш бизнес-помощник. Отраслевой банк сегодня — 82, это на 5 пунктов выше, чем неделю назад.",
  },
...
const answers: { match: string[]; text: string; action?: Action }[] = [
  ...
  },
  {
    ...
    text: "Ваш Отраслевой банк — 82. Сильнее всего его сейчас тянут вниз повторные покупки (-14%) и рост расходов на закупки (+24%). Поддерживают — выручка (91) и рост (84).",
...
function reply(question: string): { text: string; action?: Action } {
  ...
  return (
    found ?? {
      text: "Пока у меня нет данных по этому вопросу в прототипе. Могу рассказать про Отраслевой банк, клиентов, расходы или готовность к финансированию.",
    }
  );
}
